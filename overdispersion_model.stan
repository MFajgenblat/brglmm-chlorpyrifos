...
transformed parameters {
  ...
  vector[N] mu_random = z_population[Population]*sd_population + z_clone[Clone]*sd_clone + z_replicate[1:N]*sd_replicate;
  // Linear predictor
...
model {
  ...
  target += std_normal_lpdf(z_replicate);
  ...
  target += student_t_lpdf(sd_replicate | 3, 0, 5);
  // Likelihood
